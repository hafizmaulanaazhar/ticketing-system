...
<div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 mb-8">
    ...
    <div class="bg-white rounded-xl shadow-md p-6">
        ...
        <div class="space-y-3">
            ...
            <div class="flex justify-between items-center p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                <span class="text-gray-700 font-medium">{{ $report->company ?: 'Tidak ada company' }}</span>
    ...
    <div class="bg-white rounded-xl shadow-md p-6">
        ...
        <div class="space-y-3">
            ...
            <div class="flex justify-between items-center p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                <span class="text-gray-700 font-medium">{{ $report->kota_cabang ?: 'Tidak ada cabang' }}</span>
    ...
    <div class="bg-white rounded-xl shadow-md p-6">
        ...
        <div class="space-y-3">
            ...
            <div class="flex justify-between items-center p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                <span class="text-gray-700 font-medium">{{ $report->branch ?: 'Tidak ada Cabang' }}</span>
            ...
            <table class="w-full text-gray-700">
                <thead class="bg-gray-100 text-gray-600 text-sm">
                    <tr>
                        ...
                        <th class="py-3 px-4 text-center font-semibold">Total Tiket</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="bg-blue-50 font-bold">
                        <td class="py-3 px-4">Total</td>
                        <td class="py-3 px-4 text-center text-blue-600">{{ $totalTicketsByDay }}</td>
                    </tr>
                    ...
                    <tr class="border-t border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="py-3 px-4 text-center font-medium">{{ $report->total }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
        ...
        <div class="p-0">
            <table class="w-full text-gray-700">
                ...
                <tbody>
                    <tr class="bg-blue-50 font-bold">
                        <td class="py-3 px-4">Total</td>
                        <td class="py-3 px-4 text-center text-blue-600">{{ $totalTicketsByHourRange }}</td>
                    </tr>
            ...
            <table class="w-full text-gray-700">
                <thead class="bg-gray-100 text-gray-600 text-sm">
                    <tr>
                        ...
                        <th class="py-3 px-4 text-center font-semibold text-red-500">Open</th>
                        <th class="py-3 px-4 text-center font-semibold text-green-500">Close</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="bg-blue-50 font-bold">
                        <td class="py-3 px-4">Total</td>
                        <td class="py-3 px-4 text-center text-red-600">{{ $totalOpen }}</td>
                        <td class="py-3 px-4 text-center text-green-600">{{ $totalClose }}</td>
                    </tr>
                    @foreach($kategoriReports as $report)
                    <tr class="border-t border-gray-200 hover:bg-gray-50">
                        <td class="py-3 px-4 font-medium">{{ $report->category ?: 'Tidak ada Kategori' }}</td>
                        <td class="py-3 px-4 text-center text-red-500 font-medium">{{ $report->open_count }}</td>
                        <td class="py-3 px-4 text-center text-green-500 font-medium">{{ $report->close_count }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
        ...
        <div class="p-0">
            <table class="w-full text-gray-700">
                ...
                <tbody>
                    <tr class="bg-blue-50 font-bold">
                        <td class="py-3 px-4">Total</td>
                        <td class="py-3 px-4 text-center text-red-600">{{ $totalOpenApp }}</td>
                        <td class="py-3 px-4 text-center text-green-600">{{ $totalCloseApp }}</td>
                    </tr>
            ...
            <table class="w-full text-gray-700">
                ...
                <tbody>
                    ...
                    <tr class="border-t border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="py-3 px-4 text-center font-bold text-blue-600">{{ $month['total'] }}</td>
                    </tr>
                    @empty
                    <tr>
        ...
        <div class="p-0">
            <table class="w-full text-gray-700">
                <thead class="bg-gray-100 text-gray-600 text-sm">
                    <tr>
                        <th class="py-3 px-4 text-left font-semibold">Bulan</th>
                        <th class="py-3 px-4 text-center font-semibold text-red-500">Total Open</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="border-t border-gray-200 hover:bg-gray-50">
                        <td class="py-3 px-4 font-medium">{{ $month['month'] }}</td>
                        <td class="py-3 px-4 text-center font-bold text-red-600">{{ $month['total'] }}</td>
                    </tr>
                    @empty
                    <tr>
        ...
        <table class="w-full text-gray-700">
            <thead class="bg-gray-100 text-gray-600 text-sm">
                <tr>
                    ...
                    <th class="py-3 px-4 text-center font-semibold">Jumlah Tiket</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="border-t border-gray-200 hover:bg-gray-50">
                    ...
                    <td class="py-3 px-4 text-center font-bold text-blue-600">{{ $helpdesk->total }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
