    ...
    <form action="{{ route('karyawan.tickets.update', $ticket) }}" method="POST" class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="nama_helpdesk" id="nama_helpdesk" value="{{ old('nama_helpdesk', $ticket->nama_helpdesk) }}" required class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                @error('nama_helpdesk')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
