...
<div class="space-y-2">
    ...
    <a href="{{ route('admin.reports.companies') }}" class="flex items-center px-4 py-3 rounded-lg transition-colors duration-200
        {{ request()->routeIs('admin.reports.companies') ? 'bg-blue-700 text-white font-semibold shadow-inner' : 'hover:bg-blue-700 hover:text-white' }}">
        <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
        </svg>
        <span class="truncate">Laporan Company</span>
    </a>
